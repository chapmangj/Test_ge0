...
mineral_deposit = st.write_input("Hi, human! I'm Dave 2.0, your new chatbot friend. My brain has been uploaded into this digital vessel. So you're interest in NSW mineral deposits, what's the name of a mineral deposit in NSW that you're interested in?")
...
st.write (" Oh, and I'm not as sharp as my human predecessor, so be sure to double-check anything important.")
